...
# ============================================================================
FONT_BASE <- 11        # Base font size for most elements
FONT_AXIS_TITLE <- 12  # Axis titles
FONT_AXIS_TEXT <- 11  # Axis labels/tick marks
FONT_LEGEND_TITLE <- 11 # Legend titles
FONT_LEGEND_TEXT <- 11  # Legend labels
FONT_STRIP <- 11        # Facet strip text
# ============================================================================
...
obelia_long <- obelia %>%
  ...
  mutate(
    measurement_origin = case_when(
      ...
      str_detect(species_id, "plankton") ~ "Plankton Abundance (individs/L)",
...
d_p      <- filter(obelia_date, measurement_origin == "Plankton Abundance (individs/L)")
