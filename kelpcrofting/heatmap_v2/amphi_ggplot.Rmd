...
amphi <- read.csv("amphi_heatmap.csv") %>%
  ...
  select(-total_amphipoda, -for_standardizing, -amphipod_plankton_uncorrected)
```
...
p4 <- ggplot(d_b_ala, aes(x = as.numeric(sample_order),
  ...
  theme(
    axis.text.x.bottom  = element_text(size = 13, vjust = 3, hjust = 0),
    ...
    axis.text.y         = element_text(size = 13),
    axis.title.x        = element_blank(),
          legend.title     = element_text(size = 13),  # <- uniform legend title
      legend.text      = element_text(size = 13),
  ) +
  ylab("Alaria\n(ind./cm²)")+
  theme(axis.title.y = element_text(size = 13))
...
p1 <- ggplot(d_e, aes(x = date_idx, y = fct_rev(species_id), fill = measurement_value)) +
  ...
  ylab("Meroplankton\neDNA log10(ASV)") + theme(axis.title.y = element_text(size = 13))
...
p2 <- ggplot(d_p, aes(x = date_idx, y = species_id, fill = measurement_value)) +
  ...
  ylab("Abundance\n(ind./L)")+ theme(axis.title.y = element_text(size = 13))
...
p3 <- ggplot(d_b_sacc, aes(x = date_idx, y = fct_rev(species_id), fill = measurement_value)) +
  ...
  ylab("Saccharina frond\nAbundance\n(ind./cm²)")+ theme(axis.title.y = element_text(size = 13))
...
p4 <- ggplot(d_b_ala, aes(x = date_idx, y = fct_rev(species_id), fill = measurement_value)) +
  ...
  theme(
    axis.text.x       = element_text(size = 13, angle = 45, hjust = 1, vjust = 1.2),
    axis.ticks.x      = element_blank(),
    axis.text.y       = element_text(size = 13)
  ) +
  ylab("Alaria frond\nAbundance\n(ind./cm²)")+ theme(axis.title.y = element_text(size = 13))
